...
// timer
// write a function that updates the innerHTML of an element
// use setInterval to repeatedly fire that funciton every second
// add a button to your HTML
// with javascript, when the button is pressed, start the setInterval